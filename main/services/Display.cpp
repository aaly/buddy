...
void
Display::Init(const ParametersPack& config)
{
  display.init();
...
void
Display::Showtext(const Services::ParametersPack& parameters)
{
  ...
  display.setTextColor(parameters.GetParameter<uint16_t>("color"),
                       parameters.GetParameter<uint16_t>("bg_color"));

  display.setTextSize(parameters.GetParameter<uint8_t>("size"));
  display.setCursor(parameters.GetParameter<int16_t>("x"),
...
void
Display::Showimage(const Services::ParametersPack& parameters)
{
...
void
Display::Clear(const Services::ParametersPack& parameters)
{
  display.clear();
}

void
Display::SetBrightness(const Services::ParametersPack& parameters)
{
  display.setBrightness(parameters.GetParameter<int>("level"));
}

void
Display::Animate(const Services::ParametersPack& parameters)
{
...
void
Display::GetProperties(const Services::ParametersPack& parameters)
{
...
void
Display::ProgressBar(const Services::ParametersPack& parameters)
{
  int x = parameters.GetParameter<int>("x");
  int y = parameters.GetParameter<int>("y");
