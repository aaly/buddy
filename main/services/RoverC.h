...
public:
  ...
  Result<std::string> Send_Motors_iic(
    const std::valarray<int32_t>& motors_values);
  ...
  /*
   * @brief move the rover at a specific angle with the specified moderated
   * speed
   * @param angle with 0 pointing forward/north, 90 right, -90 left,  180 or
   * -180 backward/south
